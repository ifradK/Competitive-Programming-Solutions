...
int main()
{
    ...
    if(choice%3==0)
    {
        while(1)
        {
            ...
            {
                rectangle(195,50+i+line_position,205,140+i+line_position);
                rectangle(270,-40+i+line_position,280,60+i+line_position);
                rectangle(345,120+i+line_position,355,210+i+line_position);
                rectangle(420,60+i+line_position,430,150+i+line_position);

                setfillstyle(1,WHITE);
                floodfill(196,51+i+line_position,WHITE);
                floodfill(271,11+i+line_position,WHITE);
                floodfill(346,121+i+line_position,WHITE);
                floodfill(421,61+i+line_position,WHITE);
            }
            ...
            if(292.5+C_x<=125 || 332.5+C_x>=500 || 460+C_y>=500)
            {
                collision=1;
                //delay(1000);
                cleardevice();
                ...
                settextstyle(10,0,3);
                outtextxy(200,300,"POINTS GAINED:");
                outtextxy(400,300,a);
            ...
            if(position==0)
            {
                if((292.5+C_x>=142.5 && 292.5+C_x<=182.5 && 400+C_y<=60+Enemy_Car_Position && 400+C_y>=0+Enemy_Car_Position) || (332.5+C_x>=142.5 && 332.5+C_x<=182.5 && 400+C_y<=60+Enemy_Car_Position && 400+C_y>=0+Enemy_Car_Position))
                {
                    collision=1;
                    cleardevice();
                    setcolor(WHITE);
            ...
            {
                if((292.5+C_x>=217.5 && 292.5+C_x<=257.5 && 400+C_y<=60+Enemy_Car_Position && 400+C_y>=0+Enemy_Car_Position) || (332.5+C_x>=217.5 && 332.5+C_x<=257.5 && 400+C_y<=60+Enemy_Car_Position && 400+C_y>=0+Enemy_Car_Position))
                {
                    collision=1;
                    cleardevice();
                    setcolor(WHITE);
            ...
            {
                if((292.5+C_x>=292.5 && 292.5+C_x<=332.5 && 400+C_y<=70+Enemy_Car_Position && 400+C_y>=10+Enemy_Car_Position) || (332.5+C_x>=292.5 && 332.5+C_x<=332.5 && 400+C_y<=70+Enemy_Car_Position && 400+C_y>=10+Enemy_Car_Position))
                {
                    collision=1;
                    cleardevice();
                    setcolor(WHITE);
            ...
            {
                if((292.5+C_x>=367.5 && 292.5+C_x<=407.5 && 400+C_y<=70+Enemy_Car_Position && 400+C_y>=10+Enemy_Car_Position) || (332.5+C_x>=367.5 && 332.5+C_x<=407.5 && 400+C_y<=70+Enemy_Car_Position && 400+C_y>=10+Enemy_Car_Position))
                {
                    collision=1;
                    cleardevice();
                    setcolor(WHITE);
            ...
            {
                if((292.5+C_x>=442.5 && 292.5+C_x<=482.5 && 400+C_y<=70+Enemy_Car_Position && 400+C_y>=10+Enemy_Car_Position) || (332.5+C_x>=442.5 && 332.5+C_x<=482.5 && 400+C_y<=70+Enemy_Car_Position && 400+C_y>=10+Enemy_Car_Position))
                {
                    collision=1;
                    cleardevice();
                    setcolor(WHITE);
    ...
    else if(choice%3==1)
    {
        ...
        setbkcolor(CYAN);
        settextstyle(10,0,3);
        outtextxy(30,180,"USE THE ARROW KEYS TO MOVE YOUR CAR");
        outtextxy(30,230,"TRY TO AVOID COLLISION WITH THE OTHER CARS");
        outtextxy(30,280,"AND FINALLY GAIN POINTS");
    }
    ...
    else if(choice%3==2)
    {
        ...
        setbkcolor(CYAN);
        settextstyle(10,0,5);
        outtextxy(90,200,"THANKS FOR PLAYING");
        delay(5000);
    }
